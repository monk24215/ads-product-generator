// Helpers — pure functions, no side effects, easy to test.

/**
 * Validate that a slug follows the convention:
 *   lowercase, hyphens allowed, no leading/trailing hyphen, 2-32 chars.
 * Slug IS identity, so this is the gate that prevents bad routing.
 */
 ...
 * If you find yourself wanting another field, add it here — never let routing
 * logic live in two places.
 */
...
/**
 * Build the initial product.json. Marketing copy fields are populated with
 * "TODO:" placeholders so the human knows exactly what still needs writing.
 */
...
/**
 * GitHub REST helper — thin wrapper that throws clearly on errors.
 */
